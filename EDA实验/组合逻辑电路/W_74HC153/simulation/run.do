...
quietly set PROJECT_DIR "C:/EDA/W_74HC153"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/W_74HC153_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/test_74HC153.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/W_74HC153_ba.sdf postlayout.test_74HC153
add wave /test_74HC153/*
run 1000ns
