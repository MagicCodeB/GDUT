...
quietly set PROJECT_DIR "C:/EDA/W_74HC4511"
...
vlog -vlog01compat -work postlayout "${PROJECT_DIR}/designer/impl1/W_74HC4511_ba.v"
vlog "+incdir+${PROJECT_DIR}/stimulus" -vlog01compat -work postlayout "${PROJECT_DIR}/stimulus/test_74HC4511.v"

vsim -L proasic3 -L postlayout  -t 1ps -sdfmax /u1=${PROJECT_DIR}/designer/impl1/W_74HC4511_ba.sdf postlayout.test_74HC4511
add wave /test_74HC4511/*
run 1000ns
